...
ActiveRecord::Schema.define(version: 2018_08_22_135859) do
  ...
  create_table "spree_affiliate_commission_rules", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "commission_rule_id"
    t.integer "affiliate_id"
    t.decimal "rate", precision: 10
    t.decimal "fixed_commission", precision: 10
  ...
  create_table "spree_affiliates", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.string "path"
    t.string "partial"
    t.string "layout"
  ...
  create_table "spree_affiliates_promotion_rules", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "affiliate_id"
  ...
  create_table "spree_commission_rules", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.text "description"
  ...
  create_table "spree_commission_transactions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "affiliate_id"
  ...
  create_table "spree_commissions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "affiliate_id"
  ...
  create_table "spree_referrals", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "code"
    t.integer "user_id"
    t.index ["user_id"], name: "index_spree_referrals_on_user_id"
  end

  create_table "spree_referred_records", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "spree_slide_locations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "spree_slide_slide_locations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "slide_id"
  ...
  create_table "spree_slides", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.text "body"
    t.string "link_url"
    t.boolean "published"
  ...
  create_table "spree_themes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.string "state"
  ...
  create_table "spree_themes_templates", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.text "body"
    t.string "path"
    t.string "format"
  ...
  create_table "spree_users", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.decimal "referral_credits", precision: 10
